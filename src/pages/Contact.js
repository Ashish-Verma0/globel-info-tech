...
import { postFetchData } from "../components/api/Api";

const Contact = () => {
  useDocTitle("GIT | Globel Info Tech - Send us a message");
  ...
  const sendEmail = async (e) => {
    try {
      ...
      const res = await postFetchData("https://sfe-be.sfe-be.shop/contact/");
            ...
            <div className="flex flex-col text-white">
              ...
              <div className="flex my-4 w-2/3 lg:w-1/2">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="text-gray-400">Tel: +1 08055384406</p>

                  <div className="mt-5">
                    <h2 className="text-2xl">Send an E-mail</h2>
                    <p className="text-gray-400">globalinfotechs54@gmail.com</p>
                  </div>
                </div>
              </div>
